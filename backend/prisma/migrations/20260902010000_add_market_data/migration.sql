...
CREATE TABLE "mandis" (
  "id" TEXT NOT NULL, "source" TEXT NOT NULL, "sourceMarketId" TEXT,
...
CREATE TABLE "market_data_sync_checkpoints" ("id" TEXT NOT NULL, "source" TEXT NOT NULL, "lastSuccessfulObservedDate" DATE, "cursor" TEXT, "updatedAt" TIMESTAMP(3) NOT NULL, CONSTRAINT "market_data_sync_checkpoints_pkey" PRIMARY KEY ("id"));
