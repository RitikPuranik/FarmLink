        ...
        <Card>
          <form className="space-y-4" onSubmit={handleSubmit((v) => createLot.mutate(v))} noValidate>
            ...
            <div>
              ...
              <Select id="farmId" hasError={!!errors.farmId} {...register("farmId")}>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input id="quantity" type="number" step="any" hasError={!!errors.quantity} {...register("quantity")} />
            ...
            <Button type="submit" isLoading={isSubmitting || createLot.isPending}>
              Create lot
            </Button>
          </form>
        </Card>
